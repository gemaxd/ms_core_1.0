package com.mobilesales.mobilesalescore.modulos.transportadora.views.dialog
...
class TransportadoraDialogSelect : DialogFragment(){

    var simpleAdapter : TransportadoraSimpleAdapter? = null
    lateinit var db : AppDatabase
    lateinit var dialogBuilder : AlertDialog
    lateinit var listener: TransportadoraClickListener
    ...
    companion object {
        fun newInstance(listener: TransportadoraClickListener): TransportadoraDialogSelect {
            val frag = TransportadoraDialogSelect()
            val args = Bundle()
            frag.arguments = args
    ...
    fun initComponents(){
        ...
        simpleAdapter = TransportadoraSimpleAdapter(context!!, db.transportadoraDao().getAll(), listener)
    }
}
