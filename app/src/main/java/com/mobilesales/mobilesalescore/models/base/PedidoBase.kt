 ...
 */
abstract class PedidoBase : BaseObject(){
    ...
    @ColumnInfo(name = "quantidade_itens")
    var quantidade_itens: Long = 0
    ...
    @NotNull
    @ColumnInfo(name = "val_difal")
    var valDifal: Float = 0.0F
    ...
    @NotNull
    @ColumnInfo(name = "val_desconto")
    var valDesconto: Float = 0.0F

    @NotNull
    @ColumnInfo(name = "val_acrescimo")
    var valAcrescimo: Float = 0.0F

    @NotNull
    @ColumnInfo(name = "val_transporte")
    var valTransporte: Float = 0.0F
